...
var BackgroundGeneratorCarrierInterior = (function() {
    /**
     * Handles the BackgroundGeneratorCarrierInterior routine and encapsulates its core gameplay logic.
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorCarrierInterior.prototype.createRNG = function(seed) {
        var state = seed >>> 0;
        return function() {
            state += 0x6d2b79f5;
            var t = state;
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorCarrierInterior.prototype.generateLoopingNoise = function(length, step, magnitude, seed) {
        var values = [];
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorCarrierInterior.prototype.generateAllTextures = function() {
        console.log('[BackgroundGeneratorCarrierInterior] Starting texture generation...');
        ...
        console.log('[BackgroundGeneratorCarrierInterior] All textures generated!');
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorCarrierInterior.prototype.generateLayerTexture = function(layerName, layerConfig) {
        ...
        if (typeof this[layerConfig.generator] === 'function') {
            ...
            console.warn('[BackgroundGeneratorCarrierInterior] Generator "' + layerConfig.generator + '" not found');
        }
        ...
        console.log('[BackgroundGeneratorCarrierInterior] Generated: ' + layerConfig.key + ' (' + textureWidth + 'x' + worldHeight + ')');
    ...
    BackgroundGeneratorCarrierInterior.prototype.generateCorridorBack = function(graphics, random, dims) {
        ...
        graphics.lineStyle(2, 0x2a1a0d, 0.4);
        ...
        for (var i = 0; i < 20; i++) {
            ...
            graphics.fillStyle(0xffb347, alpha);
        ...
        for (var i = 0; i < 8; i++) {
            ...
            graphics.fillStyle(0x2a1a0d, 0.5);
            graphics.fillRect(px, py, pw, ph);
            
            // Panel glow
            graphics.fillStyle(0xffb347, 0.1);
    ...
    BackgroundGeneratorCarrierInterior.prototype.generateInfrastructure = function(graphics, random, dims) {
        ...
        for (var i = 0; i < 6; i++) {
            ...
            // Column detail
            graphics.fillStyle(0x4a342a, 0.6);
        ...
        for (var i = 0; i < 8; i++) {
            ...
            // Platform lights
            graphics.fillStyle(0xffb347, 0.3);
