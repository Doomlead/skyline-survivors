...
var BackgroundGeneratorSiegeInterior = (function() {
    ...
    BackgroundGeneratorSiegeInterior.prototype.generateAllTextures = function() {
        ...
        console.log('[BackgroundGeneratorSiegeInterior] All textures generated!');
    ...
    BackgroundGeneratorSiegeInterior.prototype.generateLayerTexture = function(layerName, layerConfig) {
        ...
        if (typeof this[layerConfig.generator] === 'function') {
            ...
            console.warn('[BackgroundGeneratorSiegeInterior] Generator "' + layerConfig.generator + '" not found');
        }
        ...
        console.log('[BackgroundGeneratorSiegeInterior] Generated: ' + layerConfig.key + ' (' + textureWidth + 'x' + worldHeight + ')');
    ...
    BackgroundGeneratorSiegeInterior.prototype.generateCorridorBack = function(graphics, random, dims) {
        ...
        graphics.lineStyle(2, 0x242424, 0.4);
        ...
        for (var i = 0; i < 8; i++) {
            ...
            graphics.fillStyle(0x242424, 0.5);
            graphics.fillRect(px, py, pw, ph);
            
            // Panel glow
            graphics.fillStyle(0xfacc15, 0.1);
