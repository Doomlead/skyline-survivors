...
var BackgroundGeneratorRaiderInterior = (function() {
    /**
     * Handles the BackgroundGeneratorRaiderInterior routine and encapsulates its core gameplay logic.
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorRaiderInterior.prototype.createRNG = function(seed) {
        var state = seed >>> 0;
        return function() {
            state += 0x6d2b79f5;
            var t = state;
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorRaiderInterior.prototype.generateLoopingNoise = function(length, step, magnitude, seed) {
        var values = [];
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorRaiderInterior.prototype.generateAllTextures = function() {
        console.log('[BackgroundGeneratorRaiderInterior] Starting texture generation...');
        ...
        console.log('[BackgroundGeneratorRaiderInterior] All textures generated!');
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorRaiderInterior.prototype.generateLayerTexture = function(layerName, layerConfig) {
        ...
        if (typeof this[layerConfig.generator] === 'function') {
            ...
            console.warn('[BackgroundGeneratorRaiderInterior] Generator "' + layerConfig.generator + '" not found');
        }
        ...
        console.log('[BackgroundGeneratorRaiderInterior] Generated: ' + layerConfig.key + ' (' + textureWidth + 'x' + worldHeight + ')');
    ...
    BackgroundGeneratorRaiderInterior.prototype.generateCorridorBack = function(graphics, random, dims) {
        ...
        graphics.lineStyle(2, 0x1a0d2a, 0.4);
        ...
        for (var i = 0; i < 8; i++) {
            ...
            graphics.fillStyle(0x1a0d2a, 0.5);
    ...
    BackgroundGeneratorRaiderInterior.prototype.generateInfrastructure = function(graphics, random, dims) {
        ...
        for (var x = 0; x < textureWidth; x += 60) {
            ...
            // Grate lines
            graphics.lineStyle(1, 0x0d0818, 0.6);
        ...
        for (var i = 0; i < 15; i++) {
            ...
            // Cable bundle
            graphics.fillStyle(0x1a0d2a, 0.9);
        ...
        for (var i = 0; i < 6; i++) {
            ...
            // Column detail
            graphics.fillStyle(0x3a2a4a, 0.6);
