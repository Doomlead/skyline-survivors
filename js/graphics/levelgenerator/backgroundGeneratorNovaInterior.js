...
var BackgroundGeneratorNovaInterior = (function() {
    /**
     * Handles the BackgroundGeneratorNovaInterior routine and encapsulates its core gameplay logic.
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorNovaInterior.prototype.createRNG = function(seed) {
        var state = seed >>> 0;
        return function() {
            state += 0x6d2b79f5;
            var t = state;
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorNovaInterior.prototype.generateLoopingNoise = function(length, step, magnitude, seed) {
        var values = [];
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorNovaInterior.prototype.generateAllTextures = function() {
        console.log('[BackgroundGeneratorNovaInterior] Starting texture generation...');
        ...
        console.log('[BackgroundGeneratorNovaInterior] All textures generated!');
     ...
     * Returns: value defined by the surrounding game flow.
     */
    BackgroundGeneratorNovaInterior.prototype.generateLayerTexture = function(layerName, layerConfig) {
        ...
        if (typeof this[layerConfig.generator] === 'function') {
            ...
            console.warn('[BackgroundGeneratorNovaInterior] Generator "' + layerConfig.generator + '" not found');
        }
        ...
        console.log('[BackgroundGeneratorNovaInterior] Generated: ' + layerConfig.key + ' (' + textureWidth + 'x' + worldHeight + ')');
    ...
    BackgroundGeneratorNovaInterior.prototype.generateCorridorBack = function(graphics, random, dims) {
        ...
        for (var i = 0; i < 20; i++) {
            ...
            graphics.fillStyle(0x7dd3fc, alpha);
        ...
        for (var i = 0; i < 8; i++) {
            ...
            graphics.fillStyle(0x111f3a, 0.5);
            graphics.fillRect(px, py, pw, ph);
            
            // Panel glow
            graphics.fillStyle(0x7dd3fc, 0.1);
    ...
    BackgroundGeneratorNovaInterior.prototype.generateInfrastructure = function(graphics, random, dims) {
        ...
        for (var i = 0; i < 15; i++) {
            ...
            // Cable bundle
            graphics.fillStyle(0x111f3a, 0.9);
        ...
        for (var i = 0; i < 8; i++) {
            ...
            // Platform lights
            graphics.fillStyle(0x7dd3fc, 0.3);
