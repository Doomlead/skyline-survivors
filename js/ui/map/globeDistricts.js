export function initializeDistricts(view) {
...
export function createBattleshipMarkers(view) {
...
export function getDistrictCenterCoords(config) {
...
export function drawDistricts(view) {
...
export function drawDistrictThreatPulse(view, district, projected, radius) {
...
export function setupDistrictInteraction(view) {
...
export function drawMarkers(view) {
...
export function focusDistrict(view, district, skipTweens = false) {
