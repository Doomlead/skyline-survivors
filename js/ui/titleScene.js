...
class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.fullBriefingText = [
            ...
            '',
            'SITUATION: DIRE',
            `- ${districtSummary.occupied} of ${districtSummary.total} districts under enemy control`,
            `- Friendly/threatened districts holding: ${districtSummary.friendlyThreatened}`,
