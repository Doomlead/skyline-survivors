...
function gameOver(scene) {
    ...
    scene.add.text(centerX, centerY - 50, 'GAME OVER', {
        fontSize: '58px', fontFamily: 'Orbitron', color: '#ff0000', stroke: '#000000', strokeThickness: 8
...
function winGame(scene) {
    ...
    scene.add.text(centerX, centerY - 50, 'MISSION COMPLETE!', {
        fontSize: '58px', fontFamily: 'Orbitron', color: '#00ff00', stroke: '#000000', strokeThickness: 8
    }).setOrigin(0.5).setScrollFactor(0).setDepth(999);
