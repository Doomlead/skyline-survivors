...
class AudioManager {
    ...
    initSounds() {
        ...
        // Squad feedback
        this.sounds.squadFollow = { type: 'synth', frequencies: [700, 900, 1100], duration: 0.35, waveform: 'sine', pitch: 'up' };
        this.sounds.squadSacrifice = { type: 'synth', frequencies: [600, 500, 380], duration: 0.4, waveform: 'sawtooth', pitch: 'down' };
